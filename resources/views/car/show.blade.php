        ...
        <div class="container">
          ...
          <div class="car-details-content">
            <div class="car-images-and-description">
              ...
              <div class="card car-detailed-description">
                ...
                <ul class="car-specifications">
                  ...
                  <x-car-specification :value="$car->features->power_steering">
                  Power Steering
                  </x-car-specification>
            ...
            <div class="car-details card">
              ...
              <a href="tel:{{\Illuminate\Support\Str::mask($car->phone,'*',-5)}}" class="car-details-phone">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                {{\Illuminate\Support\Str::mask($car->phone,'*',-5)}}
